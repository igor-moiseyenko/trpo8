...
define([ "angular", "angular-resource" ], function(angular, ngResource) {
	...
	var accountRepositoryModule = angular.module("accountRepositoryModule",
			[ "ngResource" ]);

	accountRepositoryModule.factory("accountRepository", [
			"$resource",
			function($resource) {
				...
				return {
					...
					findAccountByUsername : function(username) {
						...
						var accountResource = $resource(apiHost
